...
static void LCD_WriteIns(u8 u8_a_ins)
{
	...
	DIO_setPinVal(LCD_PORT,RS,LOW);
	
	DIO_setPinVal(LCD_PORT,D7,GET_BIT(u8_a_ins,7));
	DIO_setPinVal(LCD_PORT,D6,GET_BIT(u8_a_ins,6));
	DIO_setPinVal(LCD_PORT,D5,GET_BIT(u8_a_ins,5));
	DIO_setPinVal(LCD_PORT,D4,GET_BIT(u8_a_ins,4));
	DIO_setPinVal(LCD_PORT,EN,HIGH);
	DELAY_setTime(1);
	 DIO_setPinVal(LCD_PORT,EN,LOW);
	DELAY_setTime(1);
	DIO_setPinVal(LCD_PORT,D7,GET_BIT(u8_a_ins,3));
	DIO_setPinVal(LCD_PORT,D6,GET_BIT(u8_a_ins,2));
	DIO_setPinVal(LCD_PORT,D5,GET_BIT(u8_a_ins,1));
	DIO_setPinVal(LCD_PORT,D4,GET_BIT(u8_a_ins,0));
	DIO_setPinVal(LCD_PORT,EN,HIGH);
	DELAY_setTime(1);
	DIO_setPinVal(LCD_PORT,EN,LOW);
	DELAY_setTime(1);
...
static void LCD_WriteData(u8 u8_a_data)
{
		DIO_setPinVal(LCD_PORT,RS,HIGH);
		
		DIO_setPinVal(LCD_PORT,D7,GET_BIT(u8_a_data,7));
		DIO_setPinVal(LCD_PORT,D6,GET_BIT(u8_a_data,6));
		DIO_setPinVal(LCD_PORT,D5,GET_BIT(u8_a_data,5));
		DIO_setPinVal(LCD_PORT,D4,GET_BIT(u8_a_data,4));
		DIO_setPinVal(LCD_PORT,EN,HIGH);
		DELAY_setTime(1);
		DIO_setPinVal(LCD_PORT,EN,LOW);
		DELAY_setTime(1);
		DIO_setPinVal(LCD_PORT,D7,GET_BIT(u8_a_data,3));
		DIO_setPinVal(LCD_PORT,D6,GET_BIT(u8_a_data,2));
		DIO_setPinVal(LCD_PORT,D5,GET_BIT(u8_a_data,1));
		DIO_setPinVal(LCD_PORT,D4,GET_BIT(u8_a_data,0));
		DIO_setPinVal(LCD_PORT,EN,HIGH);
		DELAY_setTime(1);
		DIO_setPinVal(LCD_PORT,EN,LOW);
		DELAY_setTime(1);
...
*******************************************************************************/
 void LCD_PinsInit ()
 {
	 DIO_setPinDir(LCD_PORT,0,OUTPUT);
	 DIO_setPinDir(LCD_PORT,1,OUTPUT);
	 DIO_setPinDir(LCD_PORT,2,OUTPUT);
	 DIO_setPinDir(LCD_PORT,3,OUTPUT);
	 DIO_setPinDir(LCD_PORT,4,OUTPUT);
	 DIO_setPinDir(LCD_PORT,5,OUTPUT);
	 DIO_setPinDir(LCD_PORT,6,OUTPUT);
	 DIO_setPinDir(LCD_PORT,7,OUTPUT);
 }